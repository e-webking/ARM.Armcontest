...
class Version20160219192116 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("ALTER TABLE `arm_armcontest_domain_model_artwork` ADD CONSTRAINT `FK_647B4C401A95CB5` FOREIGN KEY (`contest`) REFERENCES `arm_armcontest_domain_model_contest` (`persistence_object_identifier`), ADD CONSTRAINT `FK_647B4C408C9F3610` FOREIGN KEY (`file`) REFERENCES `typo3_media_domain_model_image` (`persistence_object_identifier`)");
