...
class Version20160219192116 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("ALTER TABLE `arm_armcontest_domain_model_user` ADD CONSTRAINT `FK_armcontest_user_abstractparty` FOREIGN KEY (`persistence_object_identifier`) REFERENCES `typo3_party_domain_model_abstractparty` (`persistence_object_identifier`) ON DELETE CASCADE");
		$this->addSql("ALTER TABLE `arm_armcontest_domain_model_comment` ADD CONSTRAINT `FK_armcontest_comment_user` FOREIGN KEY (`user`) REFERENCES `arm_armcontest_domain_model_user` (`persistence_object_identifier`)");
		$this->addSql("ALTER TABLE `arm_armcontest_domain_model_comment` ADD CONSTRAINT `FK_armcontest_comment_artwork` FOREIGN KEY (`artwork`) REFERENCES `arm_armcontest_domain_model_artwork` (`persistence_object_identifier`)");
		$this->addSql("ALTER TABLE `arm_armcontest_domain_model_artwork` ADD CONSTRAINT `FK_armcontest_artwork_file` FOREIGN KEY (`file`) REFERENCES `typo3_media_domain_model_image` (`persistence_object_identifier`)");
		$this->addSql("ALTER TABLE `arm_armcontest_domain_model_artwork` ADD CONSTRAINT `FK_armcontest_artwork_contest` FOREIGN KEY (`contest`) REFERENCES `arm_armcontest_domain_model_contest` (`persistence_object_identifier`)");
	...
	public function down(Schema $schema) {
		...
		$this->addSql("ALTER TABLE `arm_armcontest_domain_model_artwork` DROP FOREIGN KEY FK_armcontest_artwork_contest");
		$this->addSql("ALTER TABLE `arm_armcontest_domain_model_artwork` DROP FOREIGN KEY FK_armcontest_artwork_file");
		$this->addSql("ALTER TABLE `arm_armcontest_domain_model_comment` DROP FOREIGN KEY FK_armcontest_comment_artwork");
		$this->addSql("ALTER TABLE arm_armcontest_domain_model_comment DROP FOREIGN KEY FK_armcontest_comment_user");
		$this->addSql("ALTER TABLE `arm_armcontest_domain_model_user` DROP FOREIGN KEY FK_armcontest_user_abstractparty");
